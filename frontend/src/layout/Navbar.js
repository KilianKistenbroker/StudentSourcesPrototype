...
// ****************** REUSED CODE ***************** 
  ...
  return (
    <> {data.isLoggedIn ? (
        <div className={windowDimension.winWidth > 500 ? "navbar navbar-desktop navbar-3by1" : "navbar navbar-mobile navbar-3by1"}>
              
              {windowDimension.winWidth > 500 ? 
              
                <Link onClick={() => window.location.reload()} id="logo-link" to={"/sources"}>
              ...
              <div className={windowDimension.winWidth > 500 ? "nav-nav nav-nav-desktop" : "nav-nav nav-nav-mobile"}>
                ...
                <Link to='/sources' onClick={() => window.location.reload()} style={{color: "dimgrey"}} className='root selected-root'>
                    Sources
                </Link>
