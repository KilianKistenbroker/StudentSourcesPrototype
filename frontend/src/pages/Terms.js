    ...
    return (
        <div className="App">
            ...
            <p className="legal-body">
                ...
                These terms and conditions (the "Terms and Conditions") govern the use of StudentSources (the
                "Site"). This Site is owned and operated by CSC 648 Team 4. This Site is a study resource site.
            ...
            <div className="legal-h2">Intellectual Property</div>
            <p className="legal-body">
                All content published and made available on our Site is the property of CSC 648 Team 4 and the Site's
            ...
            <div className="legal-h2">Age Restrictions</div>
            <p className="legal-body">
                The minimum age to use our Site is 13 years old. By using this Site, users agree that they are over 13
                years old. We do not assume any legal responsibility for false statements about age.
            </p><br />

            <div className="legal-h2">User Contributions</div>
            <p className="legal-body">
            ...
            <div className="legal-h2">Accounts</div>
            <p className="legal-body">
                When you create an account on our Site, you agree to the following: 
                <div className="legal-indent">
                    1. You are solely responsible for your account and the security and privacy of your account,
                    including passwords or sensitive information attached to that account; and <br />
            ...
            <div className="legal-h2">User Goods and Services</div>
            <p className="legal-body">
                Our allows users to sell goods and services. We do not assume any responsibility for the goods and
                services users sell on our Site. We cannot guarantee the quality or accuracy of any goods and services
                sold by users on our Site. However, if we are made aware that a user is violating these Terms and
                Conditions, we reserve the right to suspend or prohibit the user from selling goods and services on our
                Site.
            </p><br />

            <div className="legal-h2">Limitation of Liability</div>
            <p className="legal-body">
                CSC 648 Team 4 and our directors, officers, agents, employees, subsidiaries, and affiliates will not be
                liable for any actions, claims, losses, damages, liabilities and expenses including legal fees from your
                use of the Site.
            </p><br />

            <div className="legal-h2">Indemnity</div>
            <p className="legal-body">
                Except where prohibited by law, by using this Site you indemnify and hold harmless CSC 648 Team 4
            ...
            <div className="legal-h2">Applicable Law</div>
            <p className="legal-body">
                These Terms and Conditions are governed by the laws of the State of California.
            </p><br />

            <div className="legal-h2">Severability</div>
            <p className="legal-body">
            ...
            <div className="legal-h2">Changes</div>
            <p className="legal-body">
                These Terms and Conditions may be amended from time to time in order to maintain compliance with
                the law and to reflect any changes to the way we operate our Site and the way we expect users to behave
                on our Site. We will notify users by email of changes to these Terms and Conditions or post a notice on
                our Site.
            </p><br />

            <div className="legal-h2">Contact Details</div>
            <p className="legal-body">
                Please contact us if you have any questions or concerns. Our contact details are as follows: <br />
                ______________________________________ <br />
                sfstudent@example.com <br />
                1600 Holloway Ave, San Francisco, CA 94132 <br />
            </p><br />

            <p className="legal-body">
                Effective Date: 31st day of March, 2023
            </p><br />
